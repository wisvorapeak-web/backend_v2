...
exports.update = async (req, res) => {
  try {
    const updatedData = await Faq.findByIdAndUpdate(req.params.id, req.body, { new: true, runValidators: true });
...
exports.delete = async (req, res) => {
  try {
    const deletedData = await Faq.findByIdAndDelete(req.params.id);
